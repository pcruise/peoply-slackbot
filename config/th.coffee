...
module.exports = ()->
  ...
  method.auto_msg =
    ...
    timeout: 'Currently, we are operating from 08:00 ~ 17:00. But don\'t worry! Your message was delivered to concierge masters. We will contact you tomorrow again. Thank you!'
